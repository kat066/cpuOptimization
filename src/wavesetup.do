...
add wave -noupdate -format Logic -radix hexadecimal /test_mips_cpu/MIPS_CPU/InstructionsExecuted
add wave -noupdate -format Logic -radix hexadecimal /test_mips_cpu/MIPS_CPU/CycleCount
